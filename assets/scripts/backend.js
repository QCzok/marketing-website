  ...
  const editor = new Quill(editorContainer, {
    modules: {
      toolbar: [
        ...
        // [{ direction: "rtl" }],
        [{ size: ['small', 'large'] }],
        [{ color: ['#1B39CA', '#f2793c', '#000', '#fff', false] }],
        // [{ font: [] }],
        [{ align: [] }],
        ['clean'],
      ],
